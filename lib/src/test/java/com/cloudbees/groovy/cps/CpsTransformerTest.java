...
public class CpsTransformerTest extends AbstractGroovyCpsTest {
    ...
    public void increment() throws Throwable {
        assertEvaluate("2.0.2", "x=0;\n" + "y = x++;\n" + "z = ++x;\n" + "return x+'.'+y+'.'+z;\n");
    }

    @Test
    public void decrement() throws Throwable {
        assertEvaluate("3.5.3", "x=5;\n" + "y = x--;\n" + "z = --x;\n" + "return x+'.'+y+'.'+z;\n");
    }
    ...
    public void constructorList() throws Throwable {
        assertEvaluate(new File("/parent", "name"), "File f = ['/parent', 'name']\n" + "return f");
    ...
    public void exceptionFromNonCpsCodeShouldBeCaughtByCatchBlockInCpsCode() throws Throwable {
        String message = (String) evalCPSonly("def foo() {\n" + "  'abc'.substring(5);\n"
    ...
    public void serialization() throws Throwable {
        CpsCallableInvocation s = parseCps("def plus3(int x) {\n" + "    return x+3;\n"
                + "}\n"
                + "for (int x=0; x<10; x++) {\n"
    ...
    public void method_pointer() throws Throwable {
        ...
        assertEvaluate(List.of(3, 7), "def add = CpsTransformerTest.&add\n" + "return [ add(1,2), add(3,4) ]\n");
    ...
    public void allClassesSerializable() throws Throwable {
        ...
        assertTrue((boolean) evalCPSonly("@NonCPS\n" + "def anonymousClass() {\n"
                + "  def r = new Runnable() {\n"
                + "    @Override\n"
                + "    public void run() {}\n"
                + "  }\n"
    ...
    public void arrayLikeMultipleAssignment() throws Throwable {
        assertEvaluate("wh", "def (a,b) = 'what'\n" + "return a + b\n");
    }
    ...
    public void spreadExpression() throws Throwable {
        ...
        assertEvaluate(Collections.singletonList(null), "def x = null\n" + "return [*x]\n");
    ...
    public void spreadMapExpression() throws Throwable {
        ...
        assertEvaluate(Map.of("a", 1), "def x = [a: 1]\n" + "def id(def m) { m }\n" + "return id(*:x)\n");
    ...
    public void initialExpressionsInMethodsAreCpsTransformed() throws Throwable {
        assertEvaluate(Boolean.FALSE, "def m1() { true }\n" + "def m2(p = m1()){ false }\n" + "m2()\n");
    }
    ...
    public void methodReturnValuesShouldBeCastToDeclaredReturnType() throws Throwable {
        assertEvaluate(true, "Boolean castToBoolean(def o) { o }\n" + "castToBoolean(123)\n");
    }
    ...
    public void anonymousClass() throws Throwable {
        assertEvaluate(6, "def o = new Object() { def plusOne(x) { x + 1 } }\n" + "o.plusOne(5)");
    }

    @Issue("JENKINS-62064")
    @Test
    public void assignmentExprsEvalToRHS() throws Throwable {
        assertEvaluate(List.of(1, 1, 1), "def a = b = c = 1\n" + "[a, b, c]\n");
        assertEvaluate(List.of(2, 3, 4), "def a = b = c = 1\n" + "c += b += a += 1\n" + "[a, b, c]\n");
    }
}
