...
public class Driver {
    ...
    @SuppressFBWarnings(value = "RCN_REDUNDANT_NULLCHECK_WOULD_HAVE_BEEN_A_NPE", justification = "SpotBugs doesn't like try-with-resources in Java 11+, see https://github.com/spotbugs/spotbugs/issues/756")
