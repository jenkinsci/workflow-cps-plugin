...
public class FunctionCallBlockTest extends AbstractGroovyCpsTest {
    ...
    public void infiniteRecursion() {
        try {
            ...
            assertThat(t.toString(), equalTo("java.lang.StackOverflowError: Excessively nested closures/functions at Script1.getThing(Script1.groovy:3) - look for unbounded recursion - call depth: 1025"));
        }
    }
    ...
    public void stackTraceFixup() throws Throwable {
        ...
        assertThat(traces, hasItem(containsString("com.cloudbees.groovy.cps.impl.FunctionCallBlockTest.someSyncCode(FunctionCallBlockTest.java:")));
    }
}
