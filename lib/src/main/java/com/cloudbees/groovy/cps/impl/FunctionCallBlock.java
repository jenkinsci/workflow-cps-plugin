...
public class FunctionCallBlock extends CallSiteBlockSupport {
    ...
    @SuppressFBWarnings(value = "EI_EXPOSE_REP2", justification = "argExps is not modified by existing callers after being passed to this method and we want to avoid cloning every array")
